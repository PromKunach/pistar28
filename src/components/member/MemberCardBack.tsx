...
export function MemberCardBack({
  ...
  return (
    <div
      ref={cardRef}
      className="relative h-full w-full overflow-visible [backface-visibility:hidden] [-webkit-backface-visibility:hidden] drop-shadow-[0_20px_40px_rgba(15,23,42,0.35)]"
    >
      <div
        className="absolute inset-0 flex flex-col overflow-hidden rounded-[1.75rem] ring-1 ring-black/10"
        style={{
