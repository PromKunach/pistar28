...
export function MemberCardBack({
  ...
  return (
    <div
      ref={cardRef}
      className="relative flex h-full w-full flex-col overflow-visible rounded-[1.75rem] shadow-[0_25px_50px_-12px_rgba(15,23,42,0.45)] ring-1 ring-black/10 [backface-visibility:hidden] [-webkit-backface-visibility:hidden]"
      style={{
