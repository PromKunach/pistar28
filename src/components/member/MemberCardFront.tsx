...
export function MemberCardFront({
  ...
  return (
    <div
      ref={cardRef}
      className="relative h-full w-full overflow-visible [backface-visibility:hidden] [-webkit-backface-visibility:hidden] drop-shadow-[0_25px_50px_rgba(15,23,42,0.45)]"
    >
      <div
        className="absolute inset-0 flex flex-col overflow-hidden rounded-[1.75rem] p-3.5 ring-1 ring-black/20 sm:p-5"
        style={{
